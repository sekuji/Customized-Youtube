...
// @downloadURL   https://sekuji.xyz/Hosting/customized-yt.user.js
// @updateURL     https://sekuji.xyz/Hosting/customized-yt.user.js
...
(function() {
    ...
    const popupHTML = `
        <div id="settingsPopup" style="display: none; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); background: rgba(0, 0, 0, 0.75) !important; color: #fff !important; padding: 20px; border: 1px solid #ccc; border-radius: 15px; z-index: 1000;">
